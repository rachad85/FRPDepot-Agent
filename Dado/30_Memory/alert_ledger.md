...
- 2026-08-21 RFQ – Stock Order & High-Cube Container Quotation — Fei returned the adjusted supplier quotation; D441 availability now requires a decision between the planned dip tubes and quantities on PO-00009. Review the quotation and confirm the D441 allocation before replying.
- 2026-08-21 Fittings List / Permatech — Permatech has waited 3 business days for confirmation whether rolled sheets are acceptable as large-size pipe; verify whether Rachad already answered outside email, otherwise define the acceptable construction so pricing can proceed.
- 2026-08-21 FRP Depot CAD Bank Account / Airwallex ticket 1616235 — New support update says financial operations is now tracing the Aug 18 CAD 3,234.71 payment sent to Global Account ending 279; no reply is requested, so monitor for the return/update.
- 2026-08-21 RE: D470 Couplings -- SCT PO26330 — New SCT follow-up asks whether the order shipped and requests tracking. Fresh Zoho shows SO-00053 confirmed but shipment pending, with PKG-00045 packed/not shipped and no tracking number; verify whether pickup was arranged, then answer Bon.
